  ...
  return (
    <div className="relative">
      ...
      <div className="lg:h-[98vh] md:h-[75vh] h-[55vh]">
        <BlurImage
          image="https://res.cloudinary.com/drn5wtwrx/image/upload/v1709332858/public/event-banner_byoflm.jpg"
      ...
      <motion.div
        ...
        animate="show"
        exit="hidden"
        className="absolute flex flex-col items-center top-[40%] left-[2%] lg:left-0 gap-[3rem] lg:top-[20%] xl:top-[40%] transform -translate-x-1/2 -translate-y-1/2 text-white text-center z-10"
      >
