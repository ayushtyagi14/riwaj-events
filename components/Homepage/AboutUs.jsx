...
const AboutUs = () => {
  return (
    <>
      <div className="mb-8 md:mb-16 mt-40 md:mt-[200px] w-[90%] md:w-[95%] md:ml-24 mx-auto grid md:grid-cols-3 grid-cols-1 gap-8 items-center text-white">
        <div className="relative mx-auto md:mx-0">
          ...
          />
          <div className="pricing-card mx-auto absolute p-2 -top-16 -right-3.5 md:-right-16 w-[280px] md:w-[250px] z-[1]">
          ...
          <div className="pricing-card mx-auto absolute p-2 -bottom-24 md:-bottom-28 -right-3.5 md:-right-16 w-[280px] md:w-[250px] z-[1]">
            <p className="text-center text-[14px]">
        ...
        <div className="relative mx-auto md:mx-0 md:mt-0 mt-48">
          <img
            ...
            className="rounded-lg"
          />
          <div className="pricing-card mx-auto absolute p-2 -top-28 md:-top-20 right-3 md:-right-16 w-[280px] md:w-[250px] z-[1]">
            <p className="text-center text-[14px]">
          ...
          <div className="pricing-card mx-auto absolute p-2 -bottom-28 md:-bottom-32 right-3 md:-right-16 w-[280px] md:w-[250px] z-[1]">
            <p className="text-center text-[14px]">
        ...
        <div className="mx-auto md:mx-0 md:mt-0 mt-[60px]">
          <img
